               ...
               thread_func *function, void *aux) 
{
  ...
  /* Add new thread to parent's child list*/
  //Henry is driving
  if(tid != TID_ERROR){
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  /* Initialize sema's to wait for child to exit
     and another sema for child to be created   */
  sema_init(&t->child_wait, 0);
  sema_init(&t->child_create, 0);
  //Initialize the child list for the parent thread
